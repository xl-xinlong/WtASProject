...
/**
 * 数组转换
 * 使用方法    BytesTransUtils.getInstance()
 * @author 辛龙
 *2016年3月13日
 */
public class BytesTransHelper {

	private static BytesTransHelper instance = null;
	private BytesTransHelper() {
	}

	public static BytesTransHelper getInstance() {
		if (instance == null) {
			instance = new BytesTransHelper();
		}
		return instance;
	}
