package com.woting.activity.home.program.radiolist.rollviewpager.adapter;
...
import com.woting.activity.home.program.radiolist.rollviewpager.HintView;
...
public abstract class LoopPagerAdapter extends PagerAdapter{
    ...
    private View findViewByPosition(ViewGroup container, int position){
        for (View view : mViewList) {
            ...
            if (tag == position&&view.getParent()==null){
                return view;
            }
        }
